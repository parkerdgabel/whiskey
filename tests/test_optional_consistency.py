...
class ServiceWithMultipleOptionals:
    ...
    def __init__(self, db: Database, cache: Optional[Cache] = None, logger: Optional[Logger] = None):
        self.db = db
        self.cache = cache
        self.logger = logger
...
class TestOptionalResolution:
    ...
    def test_optional_factory_consistency(self):
        ...
        def create_service_with_optional(db: Database, cache: Optional[Cache] = None) -> ServiceWithOptionalDep:
