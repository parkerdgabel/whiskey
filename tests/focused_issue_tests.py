...
def test_sync_resolve_confusion():
    ...
    try:
        ...
        app.container.resolve_sync(MyService)
        print("✓ Sync resolution works with: container.resolve_sync()")

        # This looks like it should work but doesn't
        app.resolve(MyService)  # Returns sync, not async!
        print("✓ app.resolve() is actually synchronous")
...
def test_factory_decorator_syntax():
    ...
    class Dummy:
        pass  # Need a dummy class/function
