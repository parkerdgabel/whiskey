...
class ServiceWithComplexTypes:
    def __init__(
        ...
        nested_dict: Optional[dict[str, list[int]]] = None,
    ):
...
class TestTypeAnalysisCaching:
    ...
    def test_cache_effectiveness(self):
        ...
        assert second_run_time < first_run_time / 2, (
            f"Cache not effective: {first_run_time / second_run_time:.2f}x speedup"
        )
    ...
    def test_cache_memory_efficiency(self):
        ...
        for i in range(100):  # Reduced from 1000 for faster testing
            ...
            service_class = type(
                service_name, (), {"__init__": lambda self, dep: setattr(self, "dep", dep)}
            )
...
class TestResolutionCaching:
    ...
    def test_concurrent_resolution_performance(self):
        ...
        print("Concurrent resolution test:")
