...
class TestInjectionError:
    ...
    def test_injection_error_complete(self):
        ...
        error = InjectionError(
            "Cannot resolve union type parameter",
    ...
    def test_injection_error_with_class_type_hint(self):
        ...
        error = InjectionError(
            "Cannot inject unregistered service",
...
class TestTypeAnalysisError:
    ...
    def test_type_analysis_error_with_complex_type(self):
        ...
        error = TypeAnalysisError(
            "Cannot analyze complex union type",
...
class TestErrorUsageScenarios:
    ...
    def test_type_analysis_error_with_forward_ref(self):
        ...
        error = TypeAnalysisError(
            "Cannot resolve forward reference 'DatabaseService'",
            type_hint="DatabaseService"
        )
...
class TestErrorMessages:
    ...
    def test_long_error_messages(self):
        ...
        long_message = "This is a very long error message that contains lots of details about what went wrong during dependency injection resolution and should be handled properly by the error system" * 3
