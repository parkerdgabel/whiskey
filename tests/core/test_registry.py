...
from whiskey.core.registry import (
    ServiceRegistry, ServiceDescriptor, Scope
)
...
class TestServiceRegistry:
    ...
    def test_key_normalization(self, registry):
        ...
        # Check internal storage uses string
