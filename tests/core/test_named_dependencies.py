...
from whiskey import Container, provide, singleton, factory, scoped, inject
...
class TestNamedDependencies:
    ...
    def test_named_singleton_services(self, container):
        ...
        container.register_singleton(Database, instance=PostgresDB("postgres://primary"), name="primary")
        container.register_singleton(Database, instance=MySQLDB("mysql://readonly"), name="readonly")
    ...
    async def test_named_services_with_scopes(self, container):
        ...
        container.register(Database, factory=lambda: PostgresDB("postgres://primary"), name="primary", scope="request")
        container.register(Database, factory=lambda: MySQLDB("mysql://readonly"), name="readonly", scope="request")
