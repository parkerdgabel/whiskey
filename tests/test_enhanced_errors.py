...
def test_builtin_type_error():
    ...
    try:
        app.resolve(ServiceNeedingString)
        print("✗ FAILED: Should have raised an error")
        return False
    except ParameterResolutionError as e:
        print("✓ Got ParameterResolutionError as expected")
...
def test_constructor_failure_error():
    ...
    try:
        app.resolve(FailingService)
        print("✗ FAILED: Should have raised an error")
        return False
    except ResolutionError as e:
        print("✓ Got ResolutionError as expected")
        print(f"  Error message:\n{e}")
...
def test_optional_type_error_clarity():
    ...
    try:
        app.resolve(ServiceWithOptional)
