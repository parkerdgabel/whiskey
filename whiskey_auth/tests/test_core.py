...
class TestAuthCore:
    ...
    def test_auth_context(self):
        ...
        # Test permissions
        user_with_perms = MockUser(id=3, username="charlie", permissions=["read", "write"])
        ...
        # Test roles
        user_with_roles = MockUser(id=4, username="diana", roles=["admin", "moderator"])
...
class TestWhiskeyIntegration:
    ...
    def test_role_registration(self):
        ...
        @app.role("admin")
        class AdminRole:
            permissions: ClassVar[list[str]] = ["read", "write", "delete"]
