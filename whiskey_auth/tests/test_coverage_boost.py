...
class TestMiddlewareEdgeCases:
    ...
    async def test_auth_context_middleware(self):
        ...
        scope = {"type": "http", "auth_context": auth_ctx}
...
class TestAuthContextFeatures:
    ...
    def test_auth_context_with_role_cache(self):
        ...
        ctx = AuthContext(user=user, roles_cache={role})
    ...
    def test_auth_context_metadata(self):
        ...
        user = create_test_user()
        ctx = AuthContext(
            user=user, provider="oauth", metadata={"ip": "127.0.0.1", "user_agent": "Test"}
        )
...
class TestCoreFeatures:
    ...
    def test_permission_normalization(self):
        ...
        # Mixed permissions
        role2 = Role("mixed", permissions=["read", Permission("write", "Can write")])
...
class TestTestingUtilities:
    ...
    async def test_auth_test_container_edge_cases(self):
        ...
        with contextlib.suppress(Exception):
            await container.resolve(TestComponent)
