...
class TestASGIHandler:
    ...
    async def test_http_simple_response(self):
        ...
        # Add a simple route
        route = RouteMetadata(
            func=lambda: {"message": "Hello, World!"}, path="/hello", methods=["GET"], name="hello"
        )
    ...
    async def test_http_with_params(self):
        ...
        route = RouteMetadata(func=get_user, path="/users/{id}", methods=["GET"], name="get_user")
        manager.add_route(route)
    ...
    async def test_http_request_injection(self):
        ...
        route = RouteMetadata(
            func=echo_request, path="/echo/{value}", methods=["POST"], name="echo"
        )
        manager.add_route(route)
    ...
    async def test_websocket_handler(self):
        ...
        ws_meta = WebSocketMetadata(func=ws_handler, path="/ws", name="ws")
