...
class TestScheduledJob:
    ...
    def test_cron_based_scheduling(self):
        ...
        # Every 5 seconds
        metadata = ScheduledJobMetadata(func=lambda: "test", name="cron_job", cron="*/5 * * * * *")
    ...
    def test_start_date_constraint(self):
        ...
        metadata = ScheduledJobMetadata(
            func=lambda: "test", name="future_job", interval=60, start_date=future_start
        )
    ...
    def test_end_date_constraint(self):
        ...
        metadata = ScheduledJobMetadata(
            func=lambda: "test", name="ended_job", interval=60, end_date=past_end
        )
    ...
    def test_create_job_instance(self):
        ...
        metadata = ScheduledJobMetadata(
            func=test_func, name="test_job", interval=60, queue="special", priority=JobPriority.HIGH
        )
    ...
    def test_repr(self):
        ...
        metadata = ScheduledJobMetadata(func=lambda: None, name="test_job", cron="0 * * * *")
...
class TestJobScheduler:
    ...
    async def test_add_remove_jobs(self):
        ...
        metadata = ScheduledJobMetadata(func=lambda: "test", name="test_job", interval=60)
    ...
    async def test_job_scheduling(self):
        ...
        metadata = ScheduledJobMetadata(func=counting_job, name="frequent_job", interval=0.2)
    ...
    async def test_list_jobs(self):
        ...
        # Add multiple jobs
        metadata1 = ScheduledJobMetadata(func=lambda: None, name="job1", interval=60)
        metadata2 = ScheduledJobMetadata(func=lambda: None, name="job2", cron="0 * * * *")
    ...
    async def test_scheduler_stats(self):
        ...
        # Add jobs
        metadata1 = ScheduledJobMetadata(func=lambda: None, name="active_job", interval=60)
    ...
    async def test_error_handling(self):
        ...
        metadata = ScheduledJobMetadata(func=lambda: None, name="error_job", interval=0.1)
