...
from whiskey_ai.extension import AgentManager, LLMClient, ModelManager, ToolManager
...
class TestModelManager:
    ...
    def test_first_model_becomes_default(self):
        ...
        try:
            ...
            assert "ai.model.instance.mock" in container
...
class TestToolManager:
    ...
    def test_all_schemas(self):
        ...
        schema1 = {"type": "function", "function": {"name": "tool1", "description": "Tool 1"}}
        schema2 = {"type": "function", "function": {"name": "tool2", "description": "Tool 2"}}
