...
<<<<<<< HEAD
    ...
    conversation = manager.create(conversation_id=conversation_id, system_prompt=system_prompt)
...
<<<<<<< HEAD
    conversation_id: str, request: Request, manager: ConversationManager, client: LLMClient
=======
    conversation_id: str,
    request: Request,
...
<<<<<<< HEAD
    conversation_id: str, manager: ConversationManager, client: LLMClient
):
...
<<<<<<< HEAD
    ...
    return {"conversation_id": conversation_id, "summary": summary, "message_count": len(messages)}
=======
        max_tokens=200
    )
