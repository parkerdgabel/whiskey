...
class Trainer(ABC):
    ...
    async def train(
        ...
        try:
            ...
            for epoch in range(self.config.epochs):
                ...
                if val_loader and self._should_validate(epoch):
                    ...
                    # Early stopping
                    if self.context.should_stop_early(
                        val_metrics[self.config.early_stopping_metric]
                    ):
        ...
        return TrainingResult(
            ...
            best_metric=self.context.best_metric
            if self.context.best_metric != float("inf")
            else None,
