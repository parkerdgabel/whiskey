...
class ImprovedFactoryDecorator:
    ...
    def __call__(self, func: Callable | None = None) -> Callable:
        ...
        if func is None and self.key_or_func is not None and callable(self.key_or_func) and not inspect.isclass(self.key_or_func):
    ...
    def _determine_factory_key(self, func: Callable) -> str | type:
        ...
        if self.key_or_func is not None and (not callable(self.key_or_func) or inspect.isclass(self.key_or_func)):
