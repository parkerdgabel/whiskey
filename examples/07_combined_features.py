...
@factory(
    Database,
    name="primary",
    condition=all_conditions(env_equals("DB_TYPE", "postgres"), env_exists("PRIMARY_DB_URL")),
)
...
@factory(
    Database,
    name="primary",
    condition=all_conditions(env_equals("DB_TYPE", "mysql"), env_exists("PRIMARY_DB_URL")),
)
...
class ApplicationService:
    ...
    def __init__(
        self, logger: Annotated[Logger, Inject()], metrics: Annotated[MetricsCollector, Inject()]
    ):
        self.logger = logger
        self.metrics = metrics
