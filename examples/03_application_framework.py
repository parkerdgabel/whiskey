...
from whiskey import (
    Application, ApplicationConfig, ComponentMetadata,
    Disposable, Initializable, Inject, inject
)
...
class UserService:
    ...
    async def create_user(self, name: str, email: str) -> dict:
        ...
        try:
            ...
            # Create user object
            user = {"id": len(await self.db.query("SELECT id FROM users")) + 1, "name": name, "email": email}
